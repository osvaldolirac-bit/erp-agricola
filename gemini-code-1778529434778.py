...
# --- 2. FUNCIONES DE UTILIDAD Y BASE DE DATOS ---
...
def inicializar_db():
    ...
    # --- INYECCIÓN DE DATOS EL ESPINO (Script v10.8.87) ---
    ...
    if cursor.fetchone()[0] == 0:
        d_ex = [
            ...
            ('2026-03-09', '54846', 'Cable libre halógeno', 45346), ('2026-03-10', '23648', 'Los Olivos Perno Hex', 16950),
            ('2026-03-10', '6854929', 'Electrocom CableRV-K', 100399), ('2026-03-10', 'S/N', 'Alejandra Leviman', 112500),
            ('2026-03-11', 'S/N', 'Gustavo Contador', 315000), ('2026-03-11', '349905', 'Motor sumergible', 167171),
            ...
            ('2026-03-30', 'S/N', 'Carlos Zavala Sueldo Marzo', 620000), ('2026-04-02', 'S/N', 'Alejandra Leviman sueldo', 112500),
...
def modulo_dashboard():
    ...
    with m2: st.markdown(f"<div class='stMetric card-critico'><small>🔥 MESES ANTERIORES</small><br><span class='metric-red'>${f_puntos(d_crit)}</span><br><small style='color:red;'>CRÍTICO</small></div>", unsafe_allow_html=True)
...
def modulo_espino():
    ...
    with t2:
        ...
        # MÉTRICA GASTO A LA FECHA EN HISTORIAL
        ...
        st.download_button("📥 PDF El Espino", generar_pdf_blob(df_h.drop(columns=['id']), f"REPORTE GASTOS EL ESPINO: {f_ini} AL {f_fin}"), "espino.pdf")
...
st.set_page_config(page_title="ERP v10.8.87", layout="wide")
inicializar_db()
