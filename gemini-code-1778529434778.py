...
def modulo_dashboard():
    ...
    c4.metric("DOCS. PENDIENTES", f"{len(df_f)}"); c5.metric("SALDO PETRÓLEO", f"{f_decimal(saldo_pet)} Lts")
    st.divider()
...
# --- NAVEGACIÓN ---
st.set_page_config(page_title="ERP LA CONCEPCIÓN v10.8.23", layout="wide")
inicializar_db()
