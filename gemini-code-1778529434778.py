...
# --- 2. FUNCIONES DE UTILIDAD (ORDENADAS PARA EVITAR NAMEERROR) ---
...
def inicializar_db():
    ...
    # --- MIGRACIÓN DE DATOS EXCEL EL ESPINO (v10.8.79) ---
    ...
    if cursor.fetchone()[0] == 0:
        datos_excel = [
            ...
            ('2026-01-06', 'S/N', 'Carlos Zavala', 0),
            ('2026-01-10', 'S/N', 'Alejandra Leviman', 137500),
            ('2026-01-13', 'Coagra', 'Productos agro', 196493),
            ('2026-01-14', 'S/N', 'Carlos Lira Reembolso Imposiciones', 140556),
            ...
            ('2026-01-25', 'Danixa', 'Aplicación arañita', 50000),
            ...
            ('2026-03-02', '14895', 'Marcelo Caro Pernos', 11500),
            ('2026-03-03', 'DAB', 'Cinta plana amarratec', 11942),
            ('2026-03-03', '2237580', 'Coagra Urea granulada', 198417),
            ('2026-03-06', '6966966', 'Electrocom Contractor/Cable', 220326),
            ...
            ('2026-03-10', '23648', 'Soc. Los Olivos Perno Hex', 16950),
            ('2026-03-10', '6854929', 'Electrocom CableRV-K', 100399),
            ('2026-03-10', 'S/N', 'Alejandra Leviman', 112500),
            ('2026-03-11', 'S/N', 'Gustavo Carreño Contador', 315000),
            ('2026-03-11', '349905', 'Equipos Riego Motor sumergible', 167171),
            ('2026-03-11', '1427603', 'Vitel Cable reviflex', 108469),
            ('2026-03-11', '6954495', 'Electrocom Tubo curvable', 27703),
            ('2026-03-11', 'S/N', 'Imposiciones CZ febrero', 143483),
            ...
            ('2026-03-18', 'S/N', 'Carlos Zavala Préstamo', 0),
            ('2026-03-20', 'S/N', 'Impuesto Febrero', 0),
            ('2026-03-30', 'S/N', 'Carlos Zavala Sueldo Marzo', 620000),
            ('2026-04-02', 'S/N', 'Alejandra Leviman Sueldo', 112500),
            ('2026-04-02', 'S/N', 'Alejandra Leviman Bono', 12500),
            ...
            ('2026-04-17', '2248987', 'Coagra Zinc/Urea', 149190),
            ('2026-04-17', 'S/N', 'Alejandra Leviman', 125000),
            ('2026-04-17', '7621', 'Fermaco Fumigador 16L', 37900),
            ('2026-04-22', 'S/N', 'Duilio Pruzzo Saco Urea', 28000),
            ('2026-04-30', 'S/N', 'Carlos Zavala Sueldo', 620000),
            ('2026-04-30', 'S/N', 'Cáceres M SPA Control Heladas', 4545184),
            ('2026-05-08', 'BCI', 'Comisión tarjeta Bci', 13368),
            ('2026-05-12', 'S/N', 'CZ Imposiciones Abril', 143914),
            ('2026-05-15', '19509', 'Importadora Sendai Datalogger', 58362),
            ('2026-05-17', 'S/N', 'María Paola Torrez Arriendo', 7000000)
        ]
...
def modulo_espino():
    ...
    t1, t2 = st.tabs(["➕ Registro", "📜 Historial Dinámico"]); conn = conectar_db()
    with t1:
    ...
    with t2:
        # Rango por defecto dinámico basado en la BD
        ...
        if es_admin and not df_h.empty:
            st.divider(); st.subheader("🛡️ Edición Panel Maestro")
            id_e = st.selectbox("ID Item", df_h['id'])
            it_e = df_h[df_h['id']==id_e].iloc[0]
            n_it = st.text_input("Nuevo Item", it_e['item'])
            n_mt = st.number_input("Nuevo Monto", value=float(it_e['monto']))
            ...
            if st.button("🗑️ ELIMINAR") and st.text_input("Clave Eliminar", type="password") == CLAVE_MAESTRA:
...
st.set_page_config(page_title="ERP LA CONCEPCIÓN v10.8.79", layout="wide")
inicializar_db()
...
if not st.session_state['logged_in']: login_page()
    ...
    elif menu == "Compras": st.header("📦 Compras"); pass
