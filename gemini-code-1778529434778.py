...
# PRODUCTOS DEL PDF (Opcional: se cargan solo si la tabla está vacía)
PRODUCTOS_PDF = [
...
def inicializar_db():
    ...
    # Carga de productos solo si está vacío
...
def modulo_dashboard():
    ...
    # --- PROYECCIÓN DE 4 MESES (RESTAURADA) ---
...
with st.sidebar:
    ...
    # Indicador de Drive Activo
    if os.path.exists(JSON_KEY):
        st.success("☁️ Drive: ACTIVA")
    else:
        st.error("⚠️ Drive: DESCONECTADO (Falta secretos.json)")
