...
def inicializar_db():
    ...
    usuarios = [('osvaldolira@laconcepcion.cl', hash_password('9083')), ('secretaria@laconcepcion.cl', hash_password('1111')), ('secretarialaconcepcion2@gmail.com', hash_password('1111'))]
...
def modulo_dashboard():
    ...
    # ─── ⏰ CAPTURA DE TIEMPO ESTÁNDAR NATIVA ───
    ...
    dcrit = df_f[pd.to_datetime(df_f['fecha_vencimiento']).dt.date < pdia]['monto_total'].sum()
    ...
    with c_izq:
        ...
        dfr = pd.read_sql_query(q_base, conn)
