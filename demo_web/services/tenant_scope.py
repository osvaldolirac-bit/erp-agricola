...
def _espino_cuarteles() -> list[str]:
    """Variedades El Espino + sector legado CEREZOS (consulta histórica)."""
    from demo_web.services.espino_scope import LEGADO_SECTOR_LC_ESPINO, cuarteles_espino
