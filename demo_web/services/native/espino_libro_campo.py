...
from demo_web.services.native._helpers import fmt_dosis_lc, hoy_demo, parse_date
...
def _fmt_dosis(demo, value, unidad_dosis: str = "") -> str:
    """Centímetros cúbicos sin decimales confusos (80 cc, no 80,000)."""
    _ = demo
    return fmt_dosis_lc(value, unidad_dosis)
