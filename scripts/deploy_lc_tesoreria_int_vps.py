#!/usr/bin/env python3
"""Despliega fix Tesorería LC: incluir documentos INT- en pendientes."""
...
def main() -> None:
    ...
    if os.environ.get("SSHPASS"):
        ...
        print("Tip: export SSHPASS='...' si usa clave por contraseña.", file=sys.stderr)
    ...
    print("OK — Tesorería LC (INT-*) desplegada.")
