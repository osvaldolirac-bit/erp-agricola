...
from erp_master.web_visitas import collect_web_visitas
...
def create_app(config_object: type = Config) -> Flask:
    ...
    def _enforce_session_idle():
        ...
        if last_f is not None and (now - last_f) > idle_limit:
            ...
            return redirect(url_for("login", next=nxt, out=1))
    ...
    def home():
        ...
        for t in app.config["TENANTS"]:
            ...
            if producto == "comercial":
                item["producto_label"] = "Comercial"
                item["abrir_label"] = "Abrir Comercial"
            elif producto == "constructora":
                item["producto_label"] = "Constructora"
                item["abrir_label"] = "Abrir Constructora"
            else:
                item["producto_label"] = "ERP Agrícola"
                item["abrir_label"] = "Abrir ERP"
        ...
        groups = [
            ...
            },
            {
                "key": "constructora",
                "titulo": "Constructora",
                "subtitulo": "Obras, APU, precios PMP, compras y cobranza.",
                "tenants": [x for x in tenants_view if x.get("producto") == "constructora"],
            },
        ]
        return render_template(
            ...
            web_visitas=collect_web_visitas(),
        )
    ...
    @app.get("/api/web-visitas")
    @login_required
    def web_visitas_api():
        force = (request.args.get("refresh") or "") == "1"
        return collect_web_visitas(force=force)
