...
from rmweb.tenants import get_tenant, list_tenants
...
def cotizaciones_form(cot_id: int | None = None):
    ...
    if request.method == "POST":
        ...
        if tipo_venta not in {"servicio", "producto"}:
            tipo_venta = "servicio"
...
from rmweb.constructora_views import register_constructora_routes

register_ops_routes(app, login_required)
register_oc_routes(app, login_required)
register_ml_routes(app, login_required)
register_constructora_routes(app, login_required)
