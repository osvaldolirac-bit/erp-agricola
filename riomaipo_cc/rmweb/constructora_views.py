...
def register_constructora_routes(app, login_required):
    ...
    @app.route("/constructora/obras/nueva", methods=["POST"])
    @login_required
    ...
    @app.route("/constructora/obras/<int:obra_id>", methods=["GET", "POST"])
    @login_required
    ...
    @app.route("/constructora/apu/nuevo", methods=["GET", "POST"])
    @app.route("/constructora/apu/<int:apu_id>", methods=["GET", "POST"])
    @login_required
    ...
    # ── Cotización de obra ────────────────────────────────────────
    @app.route("/constructora/cotizaciones/nueva", methods=["GET", "POST"])
    @app.route("/constructora/cotizaciones/<int:cot_id>/editar", methods=["GET", "POST"])
    @login_required
